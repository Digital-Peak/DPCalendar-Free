...
<div class="plg-content-dpcalendar-contact-events">
	<?php if ($authoredEvents) { ?>
		<h3><?php echo $translator->translate('PLG_CONTENT_DPCALENDAR_CONTACT_EVENTS_TITLE_AUTHORED'); ?></h3>
	...
	<?php } ?>
	<?php if ($hostEvents) { ?>
		<h3><?php echo $translator->translate('PLG_CONTENT_DPCALENDAR_CONTACT_EVENTS_TITLE_HOSTS'); ?></h3>
