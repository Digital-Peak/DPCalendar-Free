...
?>
<div class="mod-dpcalendar-upcoming mod-dpcalendar-upcoming-horizontal mod-dpcalendar-upcoming-<?php echo $module->id; ?>">
					...
					<?php if ($params->get('show_location') && isset($event->locations) && $event->locations) { ?>
						<?php foreach ($event->locations as $location) { ?>
							<span class="mod-dpcalendar-upcoming-horizontal__location"
								...
								<a href="<?php echo $router->getLocationRoute($location); ?>" class="mod-dpcalendar-upcoming-horizontal__url dp-link">
