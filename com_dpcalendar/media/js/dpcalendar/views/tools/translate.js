(function (document, Joomla) {
  ...
  var callFetch = function callFetch(resource, next, queue) {
    DPCalendar.request('task=translate.fetch', function (json) {
  ...
  var callUpdate = function callUpdate(resource, next, queue) {
    DPCalendar.request('task=translate.update', function (json) {
