...
<form action="<?php echo JRoute::_('index.php?option=com_dpcalendar&view=events'); ?>"
	  method="post" name="adminForm" id="adminForm" class="com-dpcalendar-events row">
		...
		<div id="filter-bar" class="js-stools-container-bar pull-left">
			<div class="btn-group pull-left">
				<label class="element-invisible"
					   for="filter_search_start"><?php echo JText::_('COM_DPCALENDAR_VIEW_EVENTS_START_DATE_AFTER_LABEL'); ?>:</label>
			...
			<div class="btn-group pull-left">
				<label class="element-invisible" for="filter_search_end"><?php echo JText::_('COM_DPCALENDAR_VIEW_EVENTS_END_DATE_BEFORE_LABEL'); ?>
					:</label>
		...
		<table class="table table-striped" id="eventList">
			...
			<?php foreach ($this->items as $i => $item) {
				...
				<tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->catid ?>">
					...
					<td class="small hidden-phone"
						style="background: none repeat scroll 0 0 #<?php echo $item->color ?: DPCalendarHelper::getCalendar($item->catid)->color; ?>">
					</td>
