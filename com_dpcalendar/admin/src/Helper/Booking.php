...
class Booking
{
	...
	public static function getRegistrationStartDate(\stdClass $event): Date
	{
		...
		// Absolute date
		return DPCalendarHelper::getDate($event->booking_opening_date, \strlen((string)$event->booking_opening_date) === 10);
	}
	...
	public static function getRegistrationEndDate(\stdClass $event): Date
	{
		...
		// Absolute date
		return DPCalendarHelper::getDate($event->booking_closing_date, \strlen((string)$event->booking_closing_date) === 10);
	}
