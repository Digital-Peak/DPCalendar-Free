...
?>
<div class="mod-dpcalendar-upcoming mod-dpcalendar-upcoming-default mod-dpcalendar-upcoming-<?php echo $module->id; ?>">
					...
					<?php if ($params->get('show_location') && isset($event->locations) && $event->locations) { ?>
						<?php foreach ($event->locations as $location) { ?>
							<span class="mod-dpcalendar-upcoming-default__location"
								...
								<a href="<?php echo $router->getLocationRoute($location); ?>" class="mod-dpcalendar-upcoming-default__url dp-link">
