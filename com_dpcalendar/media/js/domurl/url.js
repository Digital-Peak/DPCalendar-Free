...
(function (ns) {
  ...
  var RX_HASH_REPL = /^#/;
  var RX_PATH = /(.*\/)/;
  var RX_PATH_FIX = /^\/{2,}/; // https://news.ycombinator.com/item?id=3939454
  ...
  var RX_PLUS = /\+/g;
  var RX_PATH_SEMI = /^\w:$/;
  var RX_URL_TEST = /[^/#?]/; // configure given url options
  ...
  var isIe = !isNode && ns.navigator && ns.navigator.userAgent && ~ns.navigator.userAgent.indexOf('MSIE'); // Trick to bypass Webpack's require at compile time
