...
?>
<div class="mod-dpcalendar-upcoming mod-dpcalendar-upcoming-icon mod-dpcalendar-upcoming-<?php echo $module->id; ?> dp-locations"
	...
	<div class="mod-dpcalendar-upcoming-icon__events">
		<?php foreach ($groupedEvents as $groupHeading => $events) { ?>
			...
			<?php foreach ($events as $index => $event) { ?>
				...
				<div class="mod-dpcalendar-upcoming-icon__event dp-event dp-event_<?php echo $event->ongoing_start_date ? ($event->ongoing_end_date ? 'started' : 'finished') : 'future'; ?>">
					<div class="mod-dpcalendar-upcoming-icon__information">
						<?php echo $layoutHelper->renderLayout(
							'block.icon',
							['icon' => Icon::CALENDAR, 'title' => $translator->translate('MOD_DPCALENDAR_UPCOMING_BLOG_CALENDAR')]
						); ?>
	...
	<?php if ($params->get('show_map')) { ?>
		<div class="mod-dpcalendar-upcoming-icon__map dp-map"
