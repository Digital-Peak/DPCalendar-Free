...
if (empty($this->event->earlybird)) {
	return;
}

$discounts = array_filter(
	(array)$this->event->earlybird,
...
?>
<div class="dp-booking-info__discount-earlybird dp-info-box">
	<?php foreach ($discounts as $discount) { ?>
		<div class="dp-earlybird">
			...
			<span class="dp-earlybird__description"><?php echo $discount->description; ?></span>
		</div>
	<?php } ?>
</div>
