(function () {
  ...
  document.addEventListener('DOMContentLoaded', () => {
  	document.querySelector('.dp-token-gen').addEventListener('click', (e) => {
  		...
  		document.querySelector('.dp-token').value = md5(Math.random().toString(36));

  		return false;
  	});

  	document.querySelector('.dp-token-clear').addEventListener('click', (e) => {
  		e.preventDefault();

  		document.querySelector('.dp-token').value = '';
...
//# sourceMappingURL=dptoken.js.map
