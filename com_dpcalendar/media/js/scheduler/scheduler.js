...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, require('@fullcalendar/core')) : typeof define === 'function' && define.amd ? define(['exports', '@fullcalendar/core'], factory) : (global = global || self, factory(global.FullCalendarResourceCommon = {}, global.FullCalendar));
  ...
  */
  ...
  function (_super) {
    ...
    ResourceDayHeader.prototype.render = function (props, context) {
      ...
      this.parentEl.appendChild(this.el = core.htmlToElement('<div class="fc-row ' + theme.getClass('headerRow') + '">' + '<table class="' + theme.getClass('tableGrid') + '">' + '<thead></thead>' + '</table>' + '</div>'));
      this.thead = this.el.querySelector('thead');
      var html;
      this.dateFormat = core.createFormatter(options.columnHeaderFormat || core.computeFallbackHeaderFormat(props.datesRepDistinctDays, props.dates.length));
  ...
  ***************************************************************************** */
  ...
  function (_super) {
    ...
    ResourceDayGrid.prototype.render = function (props, context) {
      ...
      dayGrid.receiveProps(_assign2({}, this.joiner.joinProps(slicedProps, resourceDayTable), {
  ...
  function buildResourceDayTable(dateProfile, dateProfileGenerator, resources, datesAboveResources) {
    ...
    return datesAboveResources ? new ResourceCommonPlugin.DayResourceTable(dayTable, resources) : new ResourceCommonPlugin.ResourceDayTable(dayTable, resources);
  }
...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, require('@fullcalendar/core'), require('@fullcalendar/resource-common'), require('@fullcalendar/timegrid'), require('@fullcalendar/resource-daygrid')) : typeof define === 'function' && define.amd ? define(['exports', '@fullcalendar/core', '@fullcalendar/resource-common', '@fullcalendar/timegrid', '@fullcalendar/resource-daygrid'], factory) : (global = global || self, factory(global.FullCalendarResourceTimeGrid = {}, global.FullCalendar, global.FullCalendarResourceCommon, global.FullCalendarTimeGrid, global.FullCalendarResourceDayGrid));
})(this, function (exports, core, ResourceCommonPlugin, TimeGridPlugin, resourceDaygrid) {
  'use strict';
  ...
  ***************************************************************************** */
  ...
  function (_super) {
    ...
    ResourceTimeGrid.prototype.render = function (props, context) {
      ...
      timeGrid.receiveProps(_assign3({}, this.joiner.joinProps(slicedProps, resourceDayTable), {
        dateProfile: dateProfile,
  ...
  function (_super) {
    ...
    ResourceTimeGridView.prototype.render = function (props, context) {
      ...
      this.resourceTimeGrid.receiveProps(_assign3({}, splitProps['timed'], {
        dateProfile: props.dateProfile,
        resourceDayTable: resourceDayTable
      }), context);

      if (this.resourceDayGrid) {
        this.resourceDayGrid.receiveProps(_assign3({}, splitProps['allDay'], {
          dateProfile: props.dateProfile,
          resourceDayTable: resourceDayTable,
          isRigid: false,
          nextDayThreshold: nextDayThreshold
...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, require('@fullcalendar/core')) : typeof define === 'function' && define.amd ? define(['exports', '@fullcalendar/core'], factory) : (global = global || self, factory(global.FullCalendarTimeline = {}, global.FullCalendar));
})(this, function (exports, core) {
  'use strict';
  /*! *****************************************************************************
  Copyright (c) Microsoft Corporation. All rights reserved.
  ...
  */
  ...
  function buildTimelineDateProfile(dateProfile, dateEnv, allOptions, dateProfileGenerator) {
    ...
    tDateProfile.emphasizeWeeks = core.isSingleDay(tDateProfile.slotDuration) && currentRangeAs('weeks', dateProfile, dateEnv) >= 2 && !allOptions.businessHours;
    /*
  ...
  */
  ...
  function (_super) {
    ...
    TimelineLaneEventRenderer.prototype.renderSegHtml = function (seg, mirrorInfo) {
      ...
      return '<a class="' + classes.join(' ') + '" style="' + core.cssToStr(this.getSkinCss(eventUi)) + '"' + (eventDef.url ? ' href="' + core.htmlEscape(eventDef.url) + '"' : '') + '>' + (timeText ? '<span class="fc-time-wrap">' + '<span class="fc-time">' + core.htmlEscape(timeText) + '</span>' + '</span>' : '') + '<span class="fc-title-wrap">' + '<span class="fc-title fc-sticky">' + (eventDef.title ? core.htmlEscape(eventDef.title) : '&nbsp;') + '</span>' + '</span>' + (isResizableFromStart ? '<div class="fc-resizer fc-start-resizer"></div>' : '') + (isResizableFromEnd ? '<div class="fc-resizer fc-end-resizer"></div>' : '') + '</a>';
    };
  ...
  function (_super) {
    ...
    TimelineView.prototype.render = function (props, context) {
      ...
      this.lane.receiveProps(_assign4({}, props, {
...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, require('@fullcalendar/core'), require('@fullcalendar/timeline'), require('@fullcalendar/resource-common')) : typeof define === 'function' && define.amd ? define(['exports', '@fullcalendar/core', '@fullcalendar/timeline', '@fullcalendar/resource-common'], factory) : (global = global || self, factory(global.FullCalendarResourceTimeline = {}, global.FullCalendar, global.FullCalendarTimeline, global.FullCalendarResourceCommon));
  ...
  */
  ...
  function (_super) {
    ...
    ResourceRow.prototype._renderSkeleton = function (context) {
      this.timeAxisTr.appendChild(this.cellEl = core.createElement('td', {
  ...
  function (_super) {
    ...
    Spreadsheet.prototype._renderSkeleton = function (context) {
      ...
      bodyEnhancedScroller.canvas.contentEl.appendChild(this.bodyContainerEl = core.createElement('div', {
        className: 'fc-rows'
  ...
  function (_super) {
    ...
    ResourceTimelineView.prototype.render = function (props, context) {
      ...
      this.lane.receiveProps(_assign5({}, splitProps[''], {
        dateProfile: props.dateProfile,
        nextDayThreshold: context.nextDayThreshold,
    ...
    ResourceTimelineView.prototype._renderSkeleton = function (context) {
      ...
      this.bodyScrollJoiner = new TimelinePlugin.ScrollJoiner('vertical', [this.spreadsheet.layout.bodyScroller, this.timeAxis.layout.bodyScroller]); // after scrolljoiner
    ...
    */
    ...
    ResourceTimelineView.prototype.updateRowProps = function (dateProfile, fallbackBusinessHours, splitProps) {
      ...
      for (var i = 0; i < rowNodes.length; i++) {
        ...
        if (rowNode.group) {
          ...
          rowComponent.receiveProps(_assign5({}, splitProps[resource.id], {
            dateProfile: dateProfile,
            nextDayThreshold: context.nextDayThreshold,
    ...
    ResourceTimelineView.prototype.queryScroll = function () {
      ...
      if (this.props.resourceStore) {
        _assign5(scroll, this.queryResourceScroll());
      }
