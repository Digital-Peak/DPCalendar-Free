...
<div class="com-dpcalendar-location__actions dp-button-bar dp-print-hide">
	...
	<?php if ($this->params->get('map_provider', 'openstreetmap') != 'none') { ?>
		<button type="button" class="dp-button dp-button-action dp-button-map-site" data-target="new"
			data-href="<?php echo $this->app->bootComponent('dpcalendar')->getMVCFactory()->createModel('Geo','Administrator')->getMapLink($this->location, $this->params->get('location_map_zoom', 10)); ?>">
		...
		<button type="button" class="dp-button dp-button-action dp-button-map-directions" data-target="new"
			data-href="<?php echo $this->app->bootComponent('dpcalendar')->getMVCFactory()->createModel('Geo','Administrator')->getDirectionsLink($this->location, $this->params->get('location_map_zoom', 10)); ?>">
