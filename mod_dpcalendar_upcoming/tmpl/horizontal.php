...
?>
<div class="mod-dpcalendar-upcoming mod-dpcalendar-upcoming-horizontal mod-dpcalendar-upcoming-<?php echo $module->id; ?> dp-locations">
					...
					<div class="mod-dpcalendar-upcoming-horizontal__information">
						...
						<?php if (($params->get('show_location') || $params->get('show_map')) && isset($event->locations) && $event->locations) { ?>
							<?php foreach ($event->locations as $location) { ?>
								<span class="mod-dpcalendar-upcoming-horizontal__location dp-location">
								...
								<?php if ($params->get('show_location')) { ?>
									<a href="<?php echo $router->getLocationRoute($location); ?>"
									   class="mod-dpcalendar-upcoming-horizontal__url dp-location__url dp-link">
